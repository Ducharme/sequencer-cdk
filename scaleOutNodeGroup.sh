...
aws eks update-nodegroup-config --cluster-name $CLUSTER_NAME --nodegroup-name $NODE_GROUP --scaling-config desiredSize=3
aws eks desc-nodegroup-config --cluster-name $CLUSTER_NAME --nodegroup-name $NODE_GROUP --scaling-config desiredSize=3
